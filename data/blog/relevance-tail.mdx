...
I like to ask an LLM to build a UI for me to explore the dataset. It just needs basic sorting by metrics, filtering, and search (yeah. use search to improve search :D)
...
And then you should use this distribution to drill down and find the exact queries that have failured/degraded. Here is that UI for this run, sort it, filter it, search it:
