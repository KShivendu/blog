...
A search engineer should be able to name the queries their system fails on, the same way they can name a failing test. That list is the result of your eval. The distribution, the percentiles and the mean are summaries of it.
