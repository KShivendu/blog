...
A search engineer should be able to name the queries their system fails on, the same way they can name a failing test. Those queries are the artifact. The distribution, the percentiles and the mean are all proxies for them.
