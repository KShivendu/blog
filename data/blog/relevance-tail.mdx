...
The first thing I do is read that same run at p25 and p50. It comes out of the per-query scores I already have, so it costs one line of numpy. Toggle the statistic:
