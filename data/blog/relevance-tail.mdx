...
- recall@100 is the safest, **84 wins against 32 losses**. Even so, a stemmer is a #[trade](ECS stems to ec, so the only distinctive term in one ClimateFEVER query stops being distinctive and it drops 33 → 0).
