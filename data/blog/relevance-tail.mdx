...
A +2.2 mean could be every query gaining 2.2. Here it's three different groups:

- **460** of the 599 queries don't move at all
- **79** improve, by 32 on average
- **60** get worse, by 20 on average
...
A saturated percentile can't show a gain. recall@10's p75 and p90 are already at 100, so a better method moves them +0.0. The 43% of queries already at 100 have no room left to improve, and they dilute the mean.
