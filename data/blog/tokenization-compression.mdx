...
**Step 1 — BPE tokenization.** BPE (Byte Pair Encoding) merges frequently co-occurring byte sequences into single tokens. "retrieval" becomes one token. " Generation" becomes one token — with the leading space, as the diagram shows. English text runs roughly 3/4 of a word per token ([OpenAI](https://help.openai.com/en/articles/4936856-what-are-tokens-and-how-to-count-them)):
