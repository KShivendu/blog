...
- As [search and generation unify](https://www.kshivendu.dev/blog/why-search#the-duality-of-search:~:text=Unified%20search%20and%20generation), token-native payloads avoid maintaining UTF-8 and token representations of the same corpus.
