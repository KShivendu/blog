...
- Some things are more valuable than others (Pareto principle). Internship >> Interesting Projects or good DSA profile >> Education/Courses/Certificates
- Highlight things in the order of how attractive they are.
...
- Focus on technical skills rather than management skills when you're applying for a fresher role. Nobody expects you to manage others.
  It's a plus you're good at it but that's not what they are looking for. So even if want to mention, don't put it on top.

## Internships:

I'll write a more detailed blog about this later on. But for now, I'd just say internships are the most attractive parts of your resume.
If you don't have one yet, try to do good projects and grab an internship based on those.
