...
I've been building search systems for a few years now: search over [420M+ software repositories](https://github.com/KShivendu/GSoC-SoftwareHeritage), distributed systems that power [billion scale vector search at Qdrant](https://qdrant.tech/) and run on almost a million machines all over the world, and reverse-engineering [how Exa does web scale search](https://www.kshivendu.dev/blog/exa-napkin-math).
...
At the age of 9, without almost any books, courses, or mentors, I taught myself to code entirely by searching. I'd type half-formed questions into Google like "add button VB.net" and land on forums like SourceForge, CodeProject, or W3Schools. I'd download source code of applications, do Ctrl+F, and figure out how things worked.
