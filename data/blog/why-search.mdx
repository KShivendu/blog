...
I've been building search systems for a few years now — building search over [420M+ software repositories](https://github.com/KShivendu/GSoC-SoftwareHeritage), building distributed systems that power [billion scale vector search at Qdrant](https://qdrant.tech/) and run on hundreds of thousands of machines all over the world, and reverse-engineering [how Exa does web scale search](https://www.kshivendu.dev/blog/exa-napkin-math).
