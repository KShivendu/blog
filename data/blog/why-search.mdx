...
draft: false
summary: "Search is everywhere, shapes who we become, and is one of the hardest problems in CS. Here's why I'm obsessed with it."
...
I've been building search systems for a few years now — building search over [420M+ software repositories](https://github.com/KShivendu/GSoC-SoftwareHeritage), building distributed systems to power [billion scale vector search at Qdrant](https://qdrant.tech/), and reverse-engineering [how Exa does web scale search](https://www.kshivendu.dev/blog/exa-napkin-math).
...
I find this extremely fascinating. Here's a diagram from the blog that explains what I mean. You can swap `???` with either search or generation. Can you even tell the difference below? What are the searched results and what are the created results? Does it even matter?:
