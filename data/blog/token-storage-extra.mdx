...
[The main post](/blog/token-storage#a-faster-alternative-to-ans-frequency-sorted-token-ids) proposed frequency-sorted token IDs + `streamvbyte` as a cheaper alternative to ANS, but only measured it on WikiText. So does it hold up on real prose/code/Hindi too?
...
| domain | chunk | zstd-dict ratio | encode µs | decode µs |
| ------ | ----: | --------------: | --------: | --------: |
| prose  |   256 |           2.60× |     541.7 |       9.0 |
| prose  |   512 |           2.66× |    1212.1 |      18.5 |
| prose  | 2,000 |           2.87× |   11874.5 |      78.1 |
| code   |   256 |           2.93× |     304.4 |       6.4 |
| code   |   512 |           3.24× |     731.9 |      12.7 |
| code   | 2,000 |           4.43× |    5053.0 |      40.2 |
| hindi  |   256 |           3.94× |     293.7 |       3.3 |
| hindi  |   512 |           4.56× |     614.0 |       5.3 |
| hindi  | 2,000 |           5.09× |    2599.7 |      30.0 |
