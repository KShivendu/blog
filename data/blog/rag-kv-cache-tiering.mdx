---
title: 'The Hot Doc Problem'
subtitle: 'KV Cache Tiering for RAG'
date: '2026-06-10'
lastmod: '2026-06-11'
...
The [previous post](/blog/token-storage) covered token-native storage: persist text as BPE token IDs with a static entropy coder for ~3× lossless compression, free OOD detection, and a representation aligned with how LLMs consume retrieved context. After publishing, the obvious follow-up question surfaced: once you've stored documents efficiently, what happens at _inference_ time?
