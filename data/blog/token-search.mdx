...
<BarChart
  ...
  subtitle="amber = jieba, violet = ES's built-in language analyzer, green = GPT-4o tokenizer · toggle metric (top) + language (bottom)"
  views={[
    {
      label: 'Chinese (zh)',
      datasets: mlLang(
        [0.0117, 0.3267, 0.3975, 0.492, 0.2686, 0.4879, 0.5268],
        [0.0, 0.296, 0.387, 0.5, 0.177, 0.485, 0.5],
        [0.0, 0.0, 0.136, 0.301, 0.0, 0.301, 0.318],
        [97.96, 41.73, 23.66, 14.0, 43.26, 14.0, 12.21]
      ),
    },
    {
      label: 'Hindi (hi)',
      datasets: mlLang(
        [0.3919, 0.3674, null, 0.625, 0.0071, 0.5465, 0.2678],
        [0.357, 0.304, null, 0.631, 0.0, 0.554, 0.0],
        [0.0, 0.0, null, 0.4, 0.0, 0.333, 0.0],
        [34.0, 39.14, null, 6.29, 97.14, 15.43, 50.86]
      ),
    },
    {
      label: 'Thai (th)',
      datasets: mlLang(
        [0.5695, 0.6159, null, 0.614, 0.0398, 0.5629, 0.4434],
        [0.613, 0.631, null, 0.631, 0.0, 0.605, 0.413],
        [0.315, 0.387, null, 0.387, 0.0, 0.315, 0.0],
        [16.92, 10.1, null, 9.82, 91.13, 15.55, 28.79]
      ),
    },
  ]}
/>
