...
3. Naive 4-byte packing is the worst option for any vocab bigger than uint16 (cl100k/o200k dropped from the chart above, not a real recommendation, see the glossary below for why), but 3-byte packing fixes most of it with no entropy coder at all. **ANS recovers further still, to 3.30x (cl100k) and 3.32x (o200k)**.
