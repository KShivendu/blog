...
<BarChart
  ...
  valueUnit="µs"
  views={[
    { label: 'All', categories: latencyData.categories, series: latencySeries(latencyData) },
    { label: 'Focus', categories: latencyFocus.categories, series: latencySeries(latencyFocus) },
  ]}
/>
