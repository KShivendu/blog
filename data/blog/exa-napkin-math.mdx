---
title: 'I Reverse-Engineered Exa.ai's Infrastructure Cost with Napkin Math'
date: '2025-09-16'
lastmod: '2025-10-02'
...
Given these, let’s assume Exa’s crawlers curate and sanitize pages efficiently enough such that :
...
| ----------------- | ---------- | ---------- | ---------- |
| **S3 storage**    | $0.02 / GB | 2 × 10³ GB | $40        |
| **Ephemeral SSD** | $0.08 / GB | 2 × 10³ GB | $160       |
| Total             |            |            | $200       |
...
- Tier 1: 10M pages × 30 crawls/month = 300M crawls
- Tier 2: 100M pages × 4 crawls/month = 400M crawls
- Tier 3: 300M pages × 2 crawls/month = 600M crawls
- Tier 4: 400M pages × 1 crawl/month = 400M crawls
- Tier 5: 190M pages × 0.33 crawls/month = 63M crawls
...
But the question is what did they improve? It might be a combination of many things: - I think they added [Hierarchical K-Means](https://www.elastic.co/search-labs/blog/k-means-for-vector-indices) for IVF. - They must have improved on the quality of clusters because of pre-training/fine-tuning and hence they could query fewer clusters (say 5 instead of 10) while maintaining similar recall. This means fewer points to compare and lower latency under high QPS.
