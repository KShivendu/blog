...
>
  <div style={{ width: '100%', overflow: 'hidden', borderRadius: '0.5rem' }}>
    <img
      src="/static/images/blogs/smoldb.png"
      alt="smoldb launch"
  ...
  <div style={{ width: '100%', overflow: 'hidden', borderRadius: '0.5rem' }}>
    <img
      src="/static/images/blogs/karpathy.png"
      alt="karpathy"
      style={{ width: '100%', height: 'auto', display: 'block' }}
    />
  </div>
  <div style={{ width: '100%', overflow: 'hidden', borderRadius: '0.5rem' }}>
    <img
      src="/static/images/blogs/tiered-multitenancy.png"
      alt="tiered-multitenancy"
      style={{ width: '100%', height: 'auto', display: 'block' }}
    />
  </div>
</div>
...
I gave talks at several places this year, including Microsoft Bangalore, PES University, and IIT Bhilai (my alma mater), covering internals of search, distributed systems and databases. Each of these opportunities were meaningful and rewarding in their own way.
...
>
  <div style={{ width: '100%', overflow: 'hidden', borderRadius: '0.5rem' }}>
    <img
      src="/static/images/blogs/djangocon-talk.jpg"
      alt="djangocon-talk"
      style={{ width: '100%', height: 'auto', display: 'block' }}
    />
  </div>
  <div style={{ width: '100%', overflow: 'hidden', borderRadius: '0.5rem' }}>
    <img
      src="/static/images/blogs/pesu.jpeg"
      alt="PESU"
      style={{ width: '100%', height: 'auto', display: 'block' }}
    />
  </div>
  <div style={{ width: '100%', overflow: 'hidden', borderRadius: '0.5rem' }}>
    <img
      src="/static/images/blogs/rust-meetup.jpg"
      alt="Rust meetup"
      style={{ width: '100%', height: 'auto', display: 'block' }}
    />
  </div>
  <div style={{ width: '100%', overflow: 'hidden', borderRadius: '0.5rem' }}>
    <img
      src="/static/images/blogs/blr-iitbh-meetup.jpg"
      alt="IIT Bhilai Alumni BLR meetup"
      style={{ width: '100%', height: 'auto', display: 'block' }}
    />
  </div>
</div>
...
>
  ...
  <div style={{ width: '100%', overflow: 'hidden', borderRadius: '0.5rem' }}>
    <img
      src="/static/images/blogs/varkala.jpg"
      alt="tiered-multitenancy"
      style={{ width: '100%', height: 'auto', display: 'block' }}
    />
  </div>
  <div style={{ width: '100%', overflow: 'hidden', borderRadius: '0.5rem' }}>
    <img
      src="/static/images/blogs/stanford.jpg"
      alt="tiered-multitenancy"
      style={{ width: '100%', height: 'auto', display: 'block' }}
    />
  </div>
  <div style={{ width: '100%', overflow: 'hidden', borderRadius: '0.5rem' }}>
    <img
      src="/static/images/blogs/sf.jpg"
      alt="tiered-multitenancy"
      style={{ width: '100%', height: 'auto', display: 'block' }}
    />
  </div>
  <div style={{ width: '100%', overflow: 'hidden', borderRadius: '0.5rem' }}>
    <img
      src="/static/images/blogs/sf-meeting.jpg"
      alt="tiered-multitenancy"
      style={{ width: '100%', height: 'auto', display: 'block' }}
    />
  </div>
  <div style={{ width: '100%', overflow: 'hidden', borderRadius: '0.5rem' }}>
    <img
      src="/static/images/blogs/sf-lunch.jpg"
      alt="tiered-multitenancy"
      style={{ width: '100%', height: 'auto', display: 'block' }}
    />
  </div>
  <div style={{ width: '100%', overflow: 'hidden', borderRadius: '0.5rem' }}>
    <img
      src="/static/images/blogs/qdrant-team-2025.jpg"
      alt="tiered-multitenancy"
      style={{ width: '100%', height: 'auto', display: 'block' }}
    />
  </div>
  <div style={{ width: '100%', overflow: 'hidden', borderRadius: '0.5rem' }}>
    <img
      src="/static/images/blogs/venice.jpg"
      alt="tiered-multitenancy"
      style={{ width: '100%', height: 'auto', display: 'block' }}
    />
  </div>
  <div style={{ width: '100%', overflow: 'hidden', borderRadius: '0.5rem' }}>
    <img
      src="/static/images/blogs/chicago-bean.jpg"
      alt="smoldb launch"
      style={{ width: '100%', height: 'auto', display: 'block' }}
    />
  </div>
