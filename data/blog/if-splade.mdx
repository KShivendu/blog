...
<LineChart
  ...
  xLabel="Median query latency (ms), lower is better →"
  ...
  series={[
    {
      ...
      text: ['naver', 'PP'],
      textPositions: ['top left', 'bottom left'],
    },
    {
      name: 'SPLADE-IF',
      color: '#10b981',
      ...
      textPositions: ['top right', 'bottom right', 'top left'],
    },
    {
      name: 'BM25',
      color: '#f59e0b',
...
<BarChart
  ...
  stacked
  title="Total Query Latency = Embed + Search (median ms)"
  valueLabel="ms"
  valueUnit=" ms"
  ...
  series={[
    {
      ...
      group: 'total',
      color: '#6366f1',
      values: [0.1, 0.3, 0.3, 0.3, 50.0, 53.2],
    },
    {
      name: 'Search',
      group: 'total',
      color: '#10b981',
      values: [3.8, 4.0, 4.0, 3.6, 6.6, 7.1],
    },
  ]}
/>
...
<BarChart
  orientation="vertical"
  title="Doc Encoding Throughput at Index Time"
  valueLabel="docs / sec"
  valueUnit=" docs/sec"
  valueScale="log"
  valueMin={50}
  ...
  series={[
    {
      ...
      colors: ['#f59e0b', '#6366f1', '#10b981', '#34d399'],
