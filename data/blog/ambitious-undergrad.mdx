...
- **Have role models and mentors.** There have been moments in my life where I didn't feel super optimistic about my programming skills. I used to avoid unwrapping abstractions (i.e. not going deep) and wanted to just get the task done and be done with it. But I got ahead of that because I got guidance from good mentors and some YouTubers like Hussein Nasser and Arpit Bhayani. On how to actually find them, see [find mentors 5-10 years ahead of you](/blog/work-at-a-startup#find-mentors-5-10-years-ahead-of-you).
...
1. This one, for the college years.
2. [Resume tips for early career devs](/blog/resume-tips), for the resume itself, where to apply, and how to ask for a referral.
