...
[I graduated in 2022](https://www.linkedin.com/in/kshivendu), did 5 internships during college, did freelance/consulting, and have been writing software post-grad for 4 years.

I currently work remotely at [Qdrant](https://github.com/qdrant/qdrant), an OSS vector database from Germany. It's a distributed database, which is one of the hardest types of softwares one can build. I have never worked at a FAANG company myself, but I have close friends across MNCs and startups, so I have some context on both.
...
- **Speak in public and take initiative.** Given [where I started](#who-is-this-for), this was the single biggest change in my four years. It's also how you end up knowing the seniors and alumni worth knowing.
...
Not every project counts as proof though. Real world hands-on practice is a billion times better than theoretical knowledge, and a tutorial e-commerce clone sits closer to the theory end. The ones that work are the ones solving a problem you actually had, because then you can answer any question an interviewer throws at it. I wanted to track my own time, so I [built something that does it](/blog/quantified-self).
...
- [Chinmay Kak](https://x.com/paraschopra/status/1936712272010965289), young engineer making significant impact, via this thread by Paras Chopra
- [Adithya S K](https://x.com/adithya_s_k), building open source AI tooling and sharing the process
