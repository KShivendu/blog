...
I currently work remotely at [Qdrant](https://github.com/qdrant/qdrant), an OSS vector database. It's a distributed database, which is one of the hardest types of softwares one can build. I have never worked at a FAANG company myself, but I have friends across MNCs and startups, so I have some context on both.
