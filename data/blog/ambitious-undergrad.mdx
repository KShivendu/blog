...
- There have been moments in my life where I didn't feel super optimistic about my programming skills. I started avoiding unwrapping abstractions (i.e. not going deep) and wanted to just get the task done and be done with it. But I got ahead of that and now I build a database which is one of the most complex software you can build.
- At one point, you'll get bored of building simple APIs and ask what's next. But that's not end of engineering. If you wanna do the hardest forms of engineering, go into deep tech. This includes distributed systems engineering (ideally stateful systems like databases), language tooling, infra, or ML.
