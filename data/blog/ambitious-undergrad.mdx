...
- **Break the experience paradox.** Students are often worried that jobs require experience and experience requires a job. You need to realize that you can build side projects, do internships at smaller companies first (sometimes for free if you really can't find anything), and then expand from there.
...
- **Internships beat everything else you can do in college.** They are easier to crack than full time jobs and they give you both the confidence and the proof of work.
