...
title: 'JSON Embeddings: Enhancing Product Metadata Extraction'
date: '2023-02-09'
lastmod: '2023-02-09'
tags: ['search', 'tricks', 'vectors']
draft: true
summary: 'Exploring the use of JSON embeddings to improve product metadata extraction and indexing in large e-commerce databases.'
images: ['/static/images/blogs/docker.svg']
authors: ['default']
