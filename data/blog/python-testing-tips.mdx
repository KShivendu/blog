...
Tests are extremely powerful. They give you confidence over the code that you've written, give you a larger picture of the codebase, and help you reproduce the bugs. I have been fortunate to learn a lot about testing - mostly from my awesome mentors at Software Heritage. In this article, I'll try to share some my insights about common best practices in unit testing and some powerful features in the python testing ecosystem.
