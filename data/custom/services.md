...
title: Build AI Products Your Customers Trust
date: '2025-01-01'
---

If you're an engineering leader at a startup looking to roll out AI to production, I can help. Over the last few years, I’ve worked with top global leading and well funded startups like Qdrant (28M Series A), SuperTokens (YC 19), FamPay (38M Series A, YC 19), Logy.ai, and others—through the challenges of AI and product development. I focus on what actually works: simple baselines, straightforward systems, and business outcomes over hype.
...
- [Request a Consultation](mailto:work@jxnl.co)
- [See Testimonials](#what-people-are-saying)
...
| ----------------------------------------- | ------------------------------------------------- | ------------- | ----------------- |
| [Qdrant](https://zapier.com/)             | Leading Vector search engine                      | VP of Product | Search, AI, Infra |
| [SuperTokens](https://hubspot.com/)       | Authentication devtool like Auth0 but open source | GM            | Auth & Devtools   |
| [FamPay](https://enterpret.com/)          | Fintech for teenagers                             | CTO           | Fintech           |
| [Logy.AI](https://tensorlake.ai/)         | AI for diagnostic in oral and eye issues          | CEO           | Healthcare, AI    |
| [Software Heritage](http://limitless.ai/) | Scraper and Archive for all OSS code              | CTO           | Big data, search  |
| [IIT Mandi](https://trunktools.com/)      | Research on forecasting network usage             | VP Eng        | Networking, ML    |
...
[Request a Consultation](https://form.typeform.com/to/hQH2X1bI)
...
[Request a Consultation](mailto:mail@kshivendu.dev)
